        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 rounded-2xl border bg-card p-8 sm:p-12">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
              Our platform combines proven study techniques like spaced repetition and the Pomodoro method with modern
              AI technology to create a comprehensive learning ecosystem that adapts to each student's unique needs.
            </p>
          </div>
          ...
          <div className="rounded-2xl border bg-card p-8 sm:p-12">
            ...
            <div className="space-y-4 text-base sm:text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                By combining AI-powered features like automated flashcard generation, intelligent study plan creation,
                and voice-to-text note-taking with proven study methodologies, we've created a platform that truly
                understands and supports the modern student's journey.
              </p>
              <p>
                Today, QuillGlow helps students organize their tasks, master their subjects through spaced repetition,
                track their progress with detailed analytics, and stay motivated with streak tracking and insights.
              </p>
            </div>
          </div>
        </section>
