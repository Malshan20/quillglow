...
import { Home, Calendar, Brain, FileText, BarChart3, Moon, Sun, LogOut, Sparkles, Heart, Search } from "lucide-react"
...
const navItems = [
  ...
  { href: "/stress-relief", icon: Heart, label: "Stress Relief" },
