    ...
    <section className="relative min-h-screen overflow-hidden pt-24 md:pt-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            AI-powered study planner, flashcards with spaced repetition, smart notes with voice input, Pomodoro timer,
            and progress analytics. Everything you need to study smarter.
          </motion.p>
